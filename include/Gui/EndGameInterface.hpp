#ifndef ENDGAMEINTERFACE_HPP_
# define ENDGAMEINTERFACE_HPP_
...
namespace AoL
{
  namespace Gui
  {
    ...
    class EndGameInterface : public IUserInterface
    {
    public:
      EndGameInterface();
      virtual ~EndGameInterface();
