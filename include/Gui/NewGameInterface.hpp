#ifndef NEWGAMEINTERFACE_HPP_
# define NEWGAMEINTERFACE_HPP_
...
namespace AoL
{
  namespace Gui
  {
    class NewGameInterface : public IUserInterface
    {
    public:
      NewGameInterface();
      virtual ~NewGameInterface();
