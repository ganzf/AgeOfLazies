...
namespace gui
{
	...
	public:
		...
		virtual void setActiveIcon(ECURSOR_ICON ) {}
		...
		virtual ECURSOR_ICON addIcon(const gui::SCursorSprite&) { return gui::ECI_NORMAL; }
		...
		*/
		virtual void changeIcon(ECURSOR_ICON, const gui::SCursorSprite&) {}

		//! Return a system-specific size which is supported for cursors. Larger icons will fail, smaller icons might work.
		virtual core::dimension2di getSupportedIconSize() const { return core::dimension2di(0,0); }

		//! Set platform specific behavior flags.
		virtual void setPlatformBehavior(ECURSOR_PLATFORM_BEHAVIOR) {}
