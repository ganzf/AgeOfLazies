...
public:
	...
	virtual void OnSetMaterial(const SMaterial&, const SMaterial&,
		bool, IMaterialRendererServices*) {}
	...
	virtual bool OnRender(IMaterialRendererServices*, E_VERTEX_TYPE) { return true; }
