...
AoL::rendering::RenderedGeneralScore::RenderedGeneralScore(AoL::rendering::Gui &gui,
...
AoL::rendering::RenderedGeneralScore::~RenderedGeneralScore()
{}

void		AoL::rendering::RenderedGeneralScore::setButtons(AoL::Gui::IModule *module)
{
...
void		AoL::rendering::RenderedGeneralScore::verifyFunctionToBeCalled(AoL::Gui::GUITypeId functionId)
{
...
void		AoL::rendering::RenderedGeneralScore::draw()
{
