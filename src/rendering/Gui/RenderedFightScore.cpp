...
AoL::rendering::RenderedFightScore::RenderedFightScore(AoL::rendering::Gui &gui,
...
AoL::rendering::RenderedFightScore::~RenderedFightScore()
{}

void		AoL::rendering::RenderedFightScore::setButtons(AoL::Gui::IModule *module)
{
...
void		AoL::rendering::RenderedFightScore::verifyFunctionToBeCalled(AoL::Gui::GUITypeId functionId)
{
...
void		AoL::rendering::RenderedFightScore::draw()
{
