...
AoL::rendering::RenderedLazyScore::RenderedLazyScore(AoL::rendering::Gui &gui,
...
AoL::rendering::RenderedLazyScore::~RenderedLazyScore()
{}

void		AoL::rendering::RenderedLazyScore::setButtons(AoL::Gui::IModule *module)
{
...
void		AoL::rendering::RenderedLazyScore::verifyFunctionToBeCalled(AoL::Gui::GUITypeId functionId)
{
...
void		AoL::rendering::RenderedLazyScore::draw()
{
