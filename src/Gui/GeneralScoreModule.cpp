...
AoL::Gui::GeneralScoreModule::GeneralScoreModule(std::wstring const &text,
...
AoL::Gui::GeneralScoreModule::~GeneralScoreModule()
{
  for (irr::u32 i = 0; i < _nbButtonsHolder; ++i)
    delete _buttonsHolder[i];
}

inline std::wstring const		&AoL::Gui::GeneralScoreModule::getText() const
{
  return (_text);
}

inline std::string const		&AoL::Gui::GeneralScoreModule::getPicturePath() const
{
  return (_picturePath);
}

inline std::vector<AoL::Gui::ButtonHolder *>	&AoL::Gui::GeneralScoreModule::getButtonsHolder()
{
  return (_buttonsHolder);
}

inline irr::u32				AoL::Gui::GeneralScoreModule::getNbButtonsHolder() const
{
  return (_nbButtonsHolder);
}

inline AoL::Gui::GUITypeId	AoL::Gui::GeneralScoreModule::getType() const
{
  return (_type);
}

inline bool			AoL::Gui::GeneralScoreModule::isHide() const
{
  return (_hide);
}

void		     			AoL::Gui::GeneralScoreModule::dump() const
{
