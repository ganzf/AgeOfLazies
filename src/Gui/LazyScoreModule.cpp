...
AoL::Gui::LazyScoreModule::LazyScoreModule(std::wstring const &text,
...
AoL::Gui::LazyScoreModule::~LazyScoreModule()
{
  for (irr::u32 i = 0; i < _nbButtonsHolder; ++i)
    delete _buttonsHolder[i];
}

inline std::wstring const		&AoL::Gui::LazyScoreModule::getText() const
{
  return (_text);
}

inline std::string const		&AoL::Gui::LazyScoreModule::getPicturePath() const
{
  return (_picturePath);
}

inline std::vector<AoL::Gui::ButtonHolder *>	&AoL::Gui::LazyScoreModule::getButtonsHolder()
{
  return (_buttonsHolder);
}

inline irr::u32				AoL::Gui::LazyScoreModule::getNbButtonsHolder() const
{
  return (_nbButtonsHolder);
}

inline AoL::Gui::GUITypeId	AoL::Gui::LazyScoreModule::getType() const
{
  return (_type);
}

inline bool			AoL::Gui::LazyScoreModule::isHide() const
{
  return (_hide);
}

void		     			AoL::Gui::LazyScoreModule::dump() const
{
